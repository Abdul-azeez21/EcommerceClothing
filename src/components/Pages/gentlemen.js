  ...
  return (
    <div>
      ...
      <section class="py-5">
        <div class="container">
          ...
          <div class="row text-center py-3">
            <div class="col col-lg-3 col-md-6 col-sm-12 col-xs-12 py-2">
              <h1>
                <i class="bi bi-calendar-plus"></i>
              </h1>
              <h2 class="py-2">Set a Date</h2>
              <h3 class="lead">
            ...
            <div class="col col-lg-3 col-md-6 col-sm-12 col-xs-12 py-2">
              ...
              <h2 class="py-2">Get Style Advice</h2>
              <h3 class="lead">
            ...
            <div class="col col-lg-3 col-md-6 col-sm-12 col-xs-12 py-2">
              ...
              <h2 class="py-2">Find Your Fit</h2>
              <h3 class="lead">
            ...
            <div class="col col-lg-3 col-md-6 col-sm-12 col-xs-12 py-2">
              ...
              <h2 class="py-2">Leave Worry-Free</h2>
              <h3 class="lead">
      ...
      <section class="container">
        <div>
          <div class="row text-center d-flex justify-content-center align-items-center">
            ...
            <div class="col col-lg-6 col-md-12 col-sm-12 py-5">
              <h5 class=" display-5">OWNABLE QUALITY</h5>
              <h3 class=" lead py-2">
      ...
      <section class="container">
        <div class="row text-center d-flex justify-content-center align-items-center">
          <div class="col col-lg-6 col-md-12 col-sm-12 py-5">
            <h5 class=" display-5">PERSONALIZED SERVICE</h5>
            <h3 class=" lead py-2">
      ...
      <section class="container">
        <div>
          <div class="row text-center d-flex justify-content-center align-items-center">
            <div class="col col-lg-6 col-md-12 col-sm-12 pt-2">
              <img
            ...
            <div class="col col-lg-6 col-md-12 col-sm-12 py-5">
              <h5 class=" display-5">Fit & Sizes</h5>
              <h3 class=" lead py-2">
